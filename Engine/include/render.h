...
void drawText(float x, float y, const char *msg, Uint8 r, Uint8 g, Uint8 b, Uint8 a, Font font, float ptSize=10.0f, float angle=0);
void drawText(float x, float y, const char *msg, Color color, Font font, float ptSize=10.0f, float angle=0);

void drawText(Vec2 pos, const char *msg, Uint8 r, Uint8 g, Uint8 b, Uint8 a, Font font, float ptSize=10.0f, float angle=0);
void drawText(Vec2 pos, const char *msg, Color color, Font font, float ptSize=10.0f, float angle=0);
